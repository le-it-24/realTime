...
void setCstring_realTime()
{
    ...
    pasteIntoString(insertStartM, insertEndM, timeNow, month);
    
    // Insert Day:
    int insertStartD = getFirstOccurenceOfChar(timeNow, ':', insertEndM+2)+1;
    int insertEndD = getFirstOccurenceOfChar(timeNow, '-', insertStartD)-1;
    pasteIntoString(insertStartD, insertEndD, timeNow, day);
    
    // Insert Hour:
    int insertStartH = getFirstOccurenceOfChar(timeNow, ':', insertEndD+2)+1;
    int insertEndH = getFirstOccurenceOfChar(timeNow, '-', insertStartH)-1;
    pasteIntoString(insertStartH, insertEndH, timeNow, hour);
    
    // Insert Minutes:
    int insertStartm = getFirstOccurenceOfChar(timeNow, ':', insertEndH+2)+1;
    int insertEndm = getFirstOccurenceOfChar(timeNow, '-', insertStartm)-1;
    pasteIntoString(insertStartm, insertEndm, timeNow, s);
    ...
    int insertEndUS = getFirstOccurenceOfChar(timeNow, '-', insertStartUS)-1;
    pasteIntoString(insertStartUS, insertEndUS, timeNow, us);
